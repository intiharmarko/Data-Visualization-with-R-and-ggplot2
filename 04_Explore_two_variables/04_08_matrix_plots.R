...
#   - when two variables are compred different types of graphics are used
#   - correlation coeffiecient is calculated for 2 continouous variables
...
ggsave(filename = "./figure/04_ggpairs_diamonds.png", 
       plot = ggpairs.plot,
       units = "cm", width = 29.7, height = 21, dpi = 600) 
