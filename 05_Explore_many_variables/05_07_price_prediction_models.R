...
# some guidelines:
#   - we will try different predictor variables (different number of predictors and sifferent predictors)
...
ggsave(filename = "./figure/05_model_performance_diamonds.png", 
       plot = last_plot(),
       units = "cm", width = 29.7, height = 21, dpi = 600) 
